...
jQuery(function ($) {
    ...
    onWindowResize(getHeaderHeight);

    // DROP DOWN MENU
    const isSmallScreen = () => $(window).width() < 836;
    ...
    $(".dropdown-menu-trigger").click(function () {
        ...
        if (_this.hasClass("active")) {
            ...
            _this.parent().find(".dropdown-menu").removeClass("active");
        } else {
            _this.addClass("active");
            _this.parent().find(".dropdown-menu").addClass("active");
        }
    });

    $(document).on("click", function (e) {
        if (
            !$(e.target).closest(".dropdown-menu, .dropdown-menu-trigger")
                .length
        ) {
            $(".dropdown-menu.active").removeClass("active");
            $(".dropdown-menu-trigger.active").removeClass("active");
        }
    });
    ...
    $(".submenu-close").click(function () {
        ...
        $(this)
            ...
            .siblings(".dropdown-menu-trigger")
            .removeClass("active");
    });
