...
<main id="main" class="page">
    <section class="sc sc-hero page-entry">
        <div class="sc-inner">
            <div class="sc-header">
                <h2 class="sc-title animate fadeIn">Terms</h2>
            </div>
            ...
            <div class="entry-content entry-fadeIn">
                ...
                <p>This website is operated by Farose Studio. Throughout the site, the terms “we”, “us” and “our” refer to Farose Studio. Farose Studio offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
