...
<main id="main" class="page-dara-single">
    <div class="cursor">
    </div>
                    ...
                    <div class="wrapper">
                        ...
                        <div class="header-content">
                            <div class="header-image blurred-media">
                                <img src="./assets/img/design/dara1.png" alt="Dara Image" draggable="false" loading="lazy">
                            </div>

                            <div class="text">
                                <h4 class="title">พี่ฟา</h4>
                                <p class="subtitle">ฟาโรส/ฟาริดา/คุณแดง</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="sc dara-single-readmore">
        ...
        <div class="sc-inner">
            <div class="sc-header">
                ...
                <h2 class="sc-title animate fadeIn">อ่านต่อ</h2>
                <div class="circle-illustration offset-r"></div>
                <div class="wrapper">
                    <div class="line to-right"></div>
                </div>
